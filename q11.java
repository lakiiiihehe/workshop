...
public class q11
{
    public static void main(String[] args)
    {
        ...
        {
            double tax= 0.01*500000 + (income-500000)*0.10d;
            System.out.println("The total tax is :Rs"+tax);
        }
         else if (income>700000 && income<=1000000)
        {
            double tax= 0.01*500000 + 0.10*200000d + (income-700000)*0.20d;
            System.out.println("The total tax is :Rs"+tax);
        }
        else if (income>1000000 && income<=2000000)
        {
            double tax= 0.01*500000 + 0.10*200000d + 0.20*300000 +(income-1000000)*0.20d;
            System.out.println("The total tax is :Rs"+tax);
        }
        else if (income>2000000 && income<=5000000)
        {
            double tax= 0.01*500000 + 0.10*200000d + 0.20*300000 +0.30*1000000+(income-2000000)*0.20d;
            System.out.println("The total tax is :Rs"+tax);
        }
        else
        {
